DESCRIPTION = "UltraZed-EV DPU-TRD related packages"

inherit packagegroup

UZ7EV_DPU_TRD_PACKAGES = " \
   avnet-uz7ev-benchmark \
   avnet-uz7ev-benchmark-boot \
...
RDEPENDS_${PN} = "${UZ7EV_DPU_TRD_PACKAGES}"
